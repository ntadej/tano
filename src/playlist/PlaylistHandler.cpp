...
void PlaylistHandler::openCSVFile(const QString &csvFile,
...
void PlaylistHandler::openJsFile(const QString &jsFile)
{
...
void PlaylistHandler::openOldFormatFile(const QString &tanoFile)
{

...
#include "ChannelsSelect.h"

ChannelsSelect::ChannelsSelect(QWidget *parent,
                             QLCDNumber *number,
...
void ChannelsSelect::process(int key)
{
    if(_digit == 1) {
        _old = _lcd->intValue();
        _number[0] = key;
...
void ChannelsSelect::channel(bool direction)
{
    int i = 0;
...
void ChannelsSelect::keyPressed()
{
